...
var transactionProcessors = new ITransactionProcessor[] { new BedAndBreakfastTransactionProcessor() };
ILedger ledger = new Ledger(store, strategies, transactionProcessors);
...
portfolio.Buy(asset3, 0.64421416m, 155.2278826m, 0, new DateTimeOffset(new DateTime(2018, 1, 15)));
